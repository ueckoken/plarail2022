 ...
 * @return {?proto.Blocks}
 */
proto.BlockState.prototype.getBlock = function() {
  return /** @type{?proto.Blocks} */ (
    jspb.Message.getWrapperField(this, proto.Blocks, 1));
};
...
*/
proto.BlockState.prototype.setBlock = function(value) {
 ...
 * @return {!proto.BlockState} returns this
 */
proto.BlockState.prototype.clearBlock = function() {
 ...
 * @return {boolean}
 */
proto.BlockState.prototype.hasBlock = function() {
...
/**
 * optional BlockId blockId = 1;
 * @return {!proto.Blocks.BlockId}
 */
proto.Blocks.prototype.getBlockid = function() {
  return /** @type {!proto.Blocks.BlockId} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
