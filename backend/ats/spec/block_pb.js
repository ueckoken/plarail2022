...
goog.exportSymbol('proto.NotifyStateRequest.BlockId', null, global);
...
proto.NotifyStateRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.NotifyStateRequest.BlockId} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.NotifyStateRequest.BlockId = {
  UNKNOWN: 0,
 ...
 * @return {!proto.NotifyStateRequest.BlockId}
 */
proto.NotifyStateRequest.prototype.getBlockid = function() {
  return /** @type {!proto.NotifyStateRequest.BlockId} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/**
 * @param {!proto.NotifyStateRequest.BlockId} value
 * @return {!proto.NotifyStateRequest} returns this
 */
proto.NotifyStateRequest.prototype.setBlockid = function(value) {
