...
proto.NotifyStateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    blockid: (f = msg.getBlockid()) && proto.Blocks.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.NotifyStateRequest} returns this
 */
proto.NotifyStateRequest.prototype.clearBlockid = function() {
 ...
 * @return {boolean}
 */
proto.NotifyStateRequest.prototype.hasBlockid = function() {
