...
class DiaPlanner:
    ...
    def setup(self) -> None:
        ...
        self.setDia(0, 'sakurajosui_down', False, 0, 'sakurajosui_b2', 'sakurajosui_b5')  # 列車0は駅(桜上水下り)に5秒停車、桜上水b2着->桜上水b5へ出発
        ...
        self.setDia(0, 'sakurajosui_up', False, 0, 'sakurajosui_b3', 'sakurajosui_b6')  # 列車0は駅(桜上水上り)に5秒停車、桜上水b3着->桜上水b6へ出発
