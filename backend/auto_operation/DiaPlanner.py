...
class DiaPlanner:
    ...
    def setup(self) -> None:
        ...
        self.setDia(0, 'sakurajosui_down', True, 5, 'sakurajosui_b1', 'sakurajosui_b5') 
        ...
        self.setDia(0, 'sakurajosui_up', True, 5, 'sakurajosui_b4', 'sakurajosui_b6') 
        self.setDia(0, 'shinjuku_up', False, 5, 'sakurajosui_b6', 'shinjuku_b2') 

        # 初期値として、列車2は橋本経由の特急とする
        self.setDia(0, 'shinjuku_down', False, 5, 'shinjuku_b2', 'shinjuku_b1') 
        self.setDia(0, 'sakurajosui_down', False, 5, 'sakurajosui_b2', 'sakurajosui_b5') 
        self.setDia(0, 'chofu_down', False, 5, 'chofu_b1', 'chofu_b3') 
        self.setDia(0, 'hashimoto_down', False, 5, 'chofu_b3', 'hashimoto_b1')  
        self.setDia(0, 'hashimoto_up', False, 5, 'hashimoto_b1', 'hashimoto_b2')  
        self.setDia(0, 'chofu_up', False, 5, 'hashimoto_b2', 'chofu_b5') 
        self.setDia(0, 'sakurajosui_up', False, 5, 'sakurajosui_b3', 'sakurajosui_b6')  
        self.setDia(0, 'shinjuku_up', False, 5, 'sakurajosui_b6', 'shinjuku_b2')
