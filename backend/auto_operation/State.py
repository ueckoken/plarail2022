...
class State:
    ...
    def __init__(self) -> None:
        ...
        self.sensorList.append(Sensor("shinjuku_d1", self.getSectionById("shinjuku_b1"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("shinjuku_d2", self.getSectionById("shinjuku_b2"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d1", self.getSectionById("sakurajosui_b1"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d2", self.getSectionById("sakurajosui_b2"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d3", self.getSectionById("sakurajosui_b3"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d4", self.getSectionById("sakurajosui_b4"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d5", self.getSectionById("sakurajosui_b5"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("sakurajosui_d6", self.getSectionById("sakurajosui_b6"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("chofu_d1", self.getSectionById("chofu_b1"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("chofu_d2", self.getSectionById("chofu_b2"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("chofu_d3", self.getSectionById("chofu_b3"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("chofu_d4", self.getSectionById("chofu_b4"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("chofu_d5", self.getSectionById("chofu_b5"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("hashimoto_d1", self.getSectionById("hashimoto_b1"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("hashimoto_d2", self.getSectionById("hashimoto_b2"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("hachioji_d1", self.getSectionById("hachioji_b1"), State.STRAIGHT_UNIT * 2))
        self.sensorList.append(Sensor("hachioji_d2", self.getSectionById("hachioji_b2"), State.STRAIGHT_UNIT * 2))
